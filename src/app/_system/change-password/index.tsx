 ...
 * @returns HTML
 */
const ChangePasswordPage = ({ title, main_path }: Props) => {
  ...
  const [check_password, checkPassword] = React.useState<boolean>(false)
  ...
  React.useEffect(() => {
    checkPassword(password ? password_regexp.test(password) : false)
  }, [password])
