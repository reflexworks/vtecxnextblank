...
vte.cx のデータ構造・アクセス制御・スキーマ設計・エラーリファレンスは以下のドキュメントを参照してください。

- [docs/vtecx/framework.md](docs/vtecx/framework.md) — vte.cx フレームワーク仕様
- [docs/vtecx/vtecxnext-api.md](docs/vtecx/vtecxnext-api.md) — vtecxnext SDK クイックリファレンス（よく使うメソッド＋実装例）
- [docs/vtecx/api/](docs/vtecx/api/index.md) — vtecxnext SDK 全メソッド網羅リファレンス（カテゴリ別）
